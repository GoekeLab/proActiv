...
The pre-calculted promoter annotation objects can be downloaded here for hg19 (Grch37):

The input data used for the example below can be downloaded from here: [preprocessedAnnotation](https://drive.google.com/drive/folders/1dtuP2QIKBTIQd8HecUmDZz2fCI_VaLMl?usp=sharing)

Example junction files as produced by TopHat2 can be downloaded here:
